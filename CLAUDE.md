...
node scripts/verify-content-ownership.js        # front/about/work/ai-enablement ownership + snapshots, the DB-owned /work/flavor-agent/demo/ snapshot, and retired-route absence (wp-cli)
