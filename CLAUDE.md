...
node scripts/verify-content-ownership.js        # front/about/work/ai-enablement/plato template ownership + snapshots, plus the DB-owned /work/flavor-agent/demo/ snapshot (wp-cli)
