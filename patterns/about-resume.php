...
<h1 class="wp-block-heading hp-about-hero__title">WordPress &amp; AI Engineer</h1>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-secondary"><a class="wp-block-button__link wp-element-button" href="/wp-content/themes/hperkins-tokens/assets/documents/henry-perkins-wordpress-support-engineer-resume.pdf">View one-page Support Engineer r&eacute;sum&eacute;</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
...
<div class="wp-block-group hp-signal"><!-- wp:paragraph {"className":"hp-signal__value"} -->
<p class="hp-signal__value">4 public projects</p>
<!-- /wp:paragraph -->
...
<!-- wp:group {"align":"wide","className":"hp-about-core-ai hp-evidence-board","layout":{"type":"default"}} -->
<div class="wp-block-group alignwide hp-about-core-ai hp-evidence-board"><!-- wp:group {"className":"hp-evidence-board__header","layout":{"type":"default"}} -->
<div class="wp-block-group hp-evidence-board__header"><!-- wp:paragraph {"className":"hp-evidence-board__kicker"} -->
<p class="hp-evidence-board__kicker">Externally verified WordPress AI work</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":2,"className":"hp-evidence-board__title"} -->
<h2 class="wp-block-heading hp-evidence-board__title">Core AI contributions</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"hp-evidence-board__summary"} -->
<p class="hp-evidence-board__summary">The strongest proof lives in records I do not control: merged upstream work, release notes, maintainer fixes, and open review threads.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"className":"hp-evidence-board__rows","layout":{"type":"default"}} -->
<div class="wp-block-group hp-evidence-board__rows"><!-- wp:group {"className":"hp-evidence-row is-status-merged is-kind-docs","layout":{"type":"default"}} -->
<div class="wp-block-group hp-evidence-row is-status-merged is-kind-docs"><!-- wp:paragraph {"className":"hp-evidence-row__label"} -->
<p class="hp-evidence-row__label">WordPress/ai PR #501 &middot; merged May 18, 2026</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"hp-evidence-row__title"} -->
<p class="hp-evidence-row__title"><a href="https://github.com/WordPress/ai/pull/501">Experiment documentation credited in AI Plugin 1.0.0</a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"hp-evidence-row__meta"} -->
<p class="hp-evidence-row__meta">Authored Content Resizing and Title Generation experiment docs; the 1.0.0 release notes list PR #501 under Various documentation updates.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"className":"hp-evidence-row is-status-merged is-kind-issue","layout":{"type":"default"}} -->
<div class="wp-block-group hp-evidence-row is-status-merged is-kind-issue"><!-- wp:paragraph {"className":"hp-evidence-row__label"} -->
<p class="hp-evidence-row__label">WordPress/ai issue #529 &middot; fixed in 1.0.1</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"hp-evidence-row__title"} -->
<p class="hp-evidence-row__title"><a href="https://github.com/WordPress/ai/issues/529">Guidelines content-type defect reported and fixed upstream</a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"hp-evidence-row__meta"} -->
<p class="hp-evidence-row__meta">Reported the defect; a core maintainer fixed it in PR #593, and AI Plugin 1.0.1 records the change.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"className":"hp-evidence-row__title"} -->
<p class="hp-evidence-row__title"><a href="https://github.com/WordPress/ai/issues/732">Issue #732</a> / <a href="https://github.com/WordPress/ai/pull/757">PR #757</a> and <a href="https://github.com/WordPress/agent-skills/pull/49">agent-skills PR #49</a></p>
<!-- /wp:paragraph -->
...
<!-- /wp:paragraph --><cite>Customer-facing WordPress &amp; AI engineer</cite></blockquote>
<!-- /wp:quote -->
...
<!-- wp:paragraph {"className":"hp-capability__text"} -->
<p class="hp-capability__text">I built Prompt Forge because I needed a place to design, iterate, and organize prompts at scale. It remains a working system I use to improve prompts without waiting for a single launch milestone.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<p class="hp-work__footer">The primary recruiter document is the <a href="/wp-content/themes/hperkins-tokens/assets/documents/henry-perkins-wordpress-support-engineer-resume.pdf">one-page Support Engineer r&eacute;sum&eacute;</a>.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h3 class="wp-block-heading hp-project__name"><a href="/work/flavor-agent/">Flavor Agent</a></h3>
<!-- /wp:heading -->
...
<p class="hp-artifact__link"><a href="https://github.com/henryperkins/flavor-agent">Code on GitHub &rarr;</a></p>
<!-- /wp:paragraph -->
...
<p class="hp-project__tech">AI Governance</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"hp-project__tech"} -->
<p class="hp-project__tech">Abilities</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"hp-project__tech"} -->
<p class="hp-project__tech">MCP</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-column hp-project"><!-- wp:heading {"level":3,"className":"hp-project__name"} -->
<h3 class="wp-block-heading hp-project__name"><a href="https://tarot.lakefrontdev.com/">Tableau</a></h3>
<!-- /wp:heading -->
...
<!-- wp:paragraph {"className":"hp-artifact__link"} -->
<p class="hp-artifact__link"><a href="https://github.com/henryperkins/tarot">Code on GitHub &rarr;</a></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"className":"hp-project__impact"} -->
<p class="hp-project__impact">A separate React/Cloudflare portfolio project. Implemented GitHub-backed content, CI checks, TypeScript UI, and deployment workflows while keeping hperkins.blog as the canonical WordPress profile.</p>
<!-- /wp:paragraph -->
