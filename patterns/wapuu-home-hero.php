...
<div class="wp-block-group alignfull hp-wapuu-hero-wrap">
	<!-- wp:group {"align":"wide","className":"hp-wapuu-hero","layout":{"type":"default"}} -->
	<div class="wp-block-group alignwide hp-wapuu-hero">
		...
		<!-- wp:group {"className":"hp-wapuu-hero__copy","layout":{"type":"default"}} -->
		<div class="wp-block-group hp-wapuu-hero__copy">
