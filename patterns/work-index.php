...
<div class="wp-block-group hp-workindex__summary"><!-- wp:group {"className":"hp-proof-bar","layout":{"type":"flex","orientation":"vertical","justifyContent":"left"}} -->
...
<!-- wp:group {"className":"hp-work","style":{"spacing":{"margin":{"top":"var:preset|spacing|8"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group hp-work" style="margin-top:var(--wp--preset--spacing--8)"><!-- wp:group {"className":"hp-work__entry is-status-review","layout":{"type":"default"}} -->
<div class="wp-block-group hp-work__entry is-status-review"><!-- wp:paragraph {"className":"hp-work__label"} -->
...
<div class="wp-block-group hp-work__entry is-status-merged"><!-- wp:paragraph {"className":"hp-work__label"} -->
