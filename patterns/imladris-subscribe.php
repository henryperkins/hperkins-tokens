...
?>
<!-- wp:html -->
<section class="hp-subscribe" aria-labelledby="hp-subscribe-title">
	...
	<form class="hp-subscribe__form" action="mailto:henry@hperkins.blog?subject=Subscribe%20to%20the%20dispatch" method="post" enctype="text/plain">
